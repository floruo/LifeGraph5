...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.ApiTeamGroup();
  });
  ...
  describe('ApiTeamGroup', function() {
    it('should create an instance of ApiTeamGroup', function() {
      // uncomment below and update the code to test ApiTeamGroup
      //var instance = new DresClientApi.ApiTeamGroup();
      //expect(instance).to.be.a(DresClientApi.ApiTeamGroup);
    });
