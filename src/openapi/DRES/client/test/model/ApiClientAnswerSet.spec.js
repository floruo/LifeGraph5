...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.ApiClientAnswerSet();
  });
  ...
  describe('ApiClientAnswerSet', function() {
    it('should create an instance of ApiClientAnswerSet', function() {
      // uncomment below and update the code to test ApiClientAnswerSet
      //var instance = new DresClientApi.ApiClientAnswerSet();
      //expect(instance).to.be.a(DresClientApi.ApiClientAnswerSet);
    });
