...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.ApiTaskOverview();
  });
  ...
  describe('ApiTaskOverview', function() {
    it('should create an instance of ApiTaskOverview', function() {
      // uncomment below and update the code to test ApiTaskOverview
      //var instance = new DresClientApi.ApiTaskOverview();
      //expect(instance).to.be.a(DresClientApi.ApiTaskOverview);
    });
