...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.ApiTargetContent();
  });
  ...
  describe('ApiTargetContent', function() {
    it('should create an instance of ApiTargetContent', function() {
      // uncomment below and update the code to test ApiTargetContent
      //var instance = new DresClientApi.ApiTargetContent();
      //expect(instance).to.be.a(DresClientApi.ApiTargetContent);
    });
