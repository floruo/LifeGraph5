...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.RankedAnswer();
  });
  ...
  describe('RankedAnswer', function() {
    it('should create an instance of RankedAnswer', function() {
      // uncomment below and update the code to test RankedAnswer
      //var instance = new DresClientApi.RankedAnswer();
      //expect(instance).to.be.a(DresClientApi.RankedAnswer);
    });
