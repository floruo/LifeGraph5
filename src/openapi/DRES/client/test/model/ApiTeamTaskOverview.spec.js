...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.ApiTeamTaskOverview();
  });
  ...
  describe('ApiTeamTaskOverview', function() {
    it('should create an instance of ApiTeamTaskOverview', function() {
      // uncomment below and update the code to test ApiTeamTaskOverview
      //var instance = new DresClientApi.ApiTeamTaskOverview();
      //expect(instance).to.be.a(DresClientApi.ApiTeamTaskOverview);
    });
