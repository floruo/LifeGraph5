...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.ApiHintContent();
  });
  ...
  describe('ApiHintContent', function() {
    it('should create an instance of ApiHintContent', function() {
      // uncomment below and update the code to test ApiHintContent
      //var instance = new DresClientApi.ApiHintContent();
      //expect(instance).to.be.a(DresClientApi.ApiHintContent);
    });
