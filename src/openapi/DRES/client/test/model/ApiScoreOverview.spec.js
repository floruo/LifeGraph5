...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.ApiScoreOverview();
  });
  ...
  describe('ApiScoreOverview', function() {
    it('should create an instance of ApiScoreOverview', function() {
      // uncomment below and update the code to test ApiScoreOverview
      //var instance = new DresClientApi.ApiScoreOverview();
      //expect(instance).to.be.a(DresClientApi.ApiScoreOverview);
    });
