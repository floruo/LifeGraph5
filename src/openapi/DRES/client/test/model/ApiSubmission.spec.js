...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.ApiSubmission();
  });
  ...
  describe('ApiSubmission', function() {
    it('should create an instance of ApiSubmission', function() {
      // uncomment below and update the code to test ApiSubmission
      //var instance = new DresClientApi.ApiSubmission();
      //expect(instance).to.be.a(DresClientApi.ApiSubmission);
    });
