...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.ApiJudgementValidatorStatus();
  });
  ...
  describe('ApiJudgementValidatorStatus', function() {
    it('should create an instance of ApiJudgementValidatorStatus', function() {
      // uncomment below and update the code to test ApiJudgementValidatorStatus
      //var instance = new DresClientApi.ApiJudgementValidatorStatus();
      //expect(instance).to.be.a(DresClientApi.ApiJudgementValidatorStatus);
    });
