...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.ApiMediaItem();
  });
  ...
  describe('ApiMediaItem', function() {
    it('should create an instance of ApiMediaItem', function() {
      // uncomment below and update the code to test ApiMediaItem
      //var instance = new DresClientApi.ApiMediaItem();
      //expect(instance).to.be.a(DresClientApi.ApiMediaItem);
    });

    it('should have the property mediaItemId (base name: "mediaItemId")', function() {
      // uncomment below and update the code to test the property mediaItemId
      //var instance = new DresClientApi.ApiMediaItem();
