...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.ApiAnswerSet();
  });
  ...
  describe('ApiAnswerSet', function() {
    it('should create an instance of ApiAnswerSet', function() {
      // uncomment below and update the code to test ApiAnswerSet
      //var instance = new DresClientApi.ApiAnswerSet();
      //expect(instance).to.be.a(DresClientApi.ApiAnswerSet);
    });
