...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.ApiClientEvaluationInfo();
  });
  ...
  describe('ApiClientEvaluationInfo', function() {
    it('should create an instance of ApiClientEvaluationInfo', function() {
      // uncomment below and update the code to test ApiClientEvaluationInfo
      //var instance = new DresClientApi.ApiClientEvaluationInfo();
      //expect(instance).to.be.a(DresClientApi.ApiClientEvaluationInfo);
    });
