...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.TemporalRange();
  });
  ...
  describe('TemporalRange', function() {
    it('should create an instance of TemporalRange', function() {
      // uncomment below and update the code to test TemporalRange
      //var instance = new DresClientApi.TemporalRange();
      //expect(instance).to.be.a(DresClientApi.TemporalRange);
    });
