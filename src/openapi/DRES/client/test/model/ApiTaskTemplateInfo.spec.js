...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DresClientApi.ApiTaskTemplateInfo();
  });
  ...
  describe('ApiTaskTemplateInfo', function() {
    it('should create an instance of ApiTaskTemplateInfo', function() {
      // uncomment below and update the code to test ApiTaskTemplateInfo
      //var instance = new DresClientApi.ApiTaskTemplateInfo();
      //expect(instance).to.be.a(DresClientApi.ApiTaskTemplateInfo);
    });
